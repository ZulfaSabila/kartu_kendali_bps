        ...
        <div class="col-12 mt-3">
            <div class="card-bps border-danger border-opacity-25">
                <div class="bg-danger bg-opacity-10 p-3 border-bottom border-danger border-opacity-25">
                    <h6 class="fw-bold mb-0 text-danger"><i class="bi bi-exclamation-triangle-fill me-2"></i>Hapus Akun</h6>
                    <p class="text-danger small mb-0 mt-1 opacity-75" style="font-size: 0.75rem;">Tindakan ini tidak dapat dibatalkan.</p>
                </div>
                <div class="p-3 p-md-4">
                    <p class="text-muted small mb-3" style="font-size: 0.8rem;">
                        Setelah akun dihapus, semua data akan dihapus secara permanen. Sebelum menghapus akun, silakan unduh data yang mungkin Anda perlukan.
                    </p>

                    <button type="button" class="btn btn-outline-danger btn-bps px-4" data-bs-toggle="modal" data-bs-target="#deleteAccountModal">
                ...
                <form method="POST" action="{{ route('profile.destroy') }}">
                    ...
                    <div class="modal-body p-4 p-md-5">
                        <p class="text-muted mb-4">
                            Apakah Anda yakin ingin menghapus akun? Masukkan password Anda untuk mengonfirmasi bahwa Anda ingin menghapus akun Anda secara permanen.
                        </p>
                        <div class="mb-0">
                            <label class="form-label">Konfirmasi Password</label>
                            <input type="password" name="password" class="form-control @error('password', 'userDeletion') is-invalid @enderror" placeholder="Masukkan password Anda">
